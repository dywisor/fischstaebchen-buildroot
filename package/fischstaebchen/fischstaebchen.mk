...
FISCHSTAEBCHEN_MAKEOPTS += SHFUNC_LIBDIR=$(FISCHSTAEBCHEN_DATADIR)/shfunc
...
FISCHSTAEBCHEN_SHELL_FUNCTIONS_SELECTION =
ifeq ($(BR2_PACKAGE_FISCHSTAEBCHEN_SHELL_FUNCTIONS_BASE),y)
FISCHSTAEBCHEN_SHELL_FUNCTIONS_SELECTION += base
endif

FISCHSTAEBCHEN_SHELL_FUNCTIONS_MAKEOPTS  = $(FISCHSTAEBCHEN_MAKEOPTS)
FISCHSTAEBCHEN_SHELL_FUNCTIONS_MAKEOPTS += \
	FUNCTIONS="$(FISCHSTAEBCHEN_SHELL_FUNCTIONS_SELECTION)"
...
ifeq ($(BR2_PACKAGE_FISCHSTAEBCHEN_INIT_READ_PROC_CMDLINE),y)
FISCHSTAEBCHEN_INIT_PROGS += read-proc-cmdline
endif

ifeq ($(BR2_PACKAGE_FISCHSTAEBCHEN_INIT_READ_PROC_ENVIRON),y)
FISCHSTAEBCHEN_INIT_PROGS += read-proc-environ
endif
...
endef
endif # if BR2_PACKAGE_COREUTILS
...
endif # if BR2_PACKAGE_FISCHSTAEBCHEN_OVERLAY
...
endif # if FISCHSTAEBCHEN_INIT_PROGS
...
define FISCHSTAEBCHEN_DO_BUILD_OVERLAY
	$(TARGET_MAKE_ENV) $(MAKE) -C '$(@D)/overlay' $(FISCHSTAEBCHEN_OVERLAY_MAKEOPTS) \
		...
		METASH_DEFAULTS_FILE='$(@D)/metash_vdef.local' \
		overlay
endef
...
ifeq ($(BR2_PACKAGE_FISCHSTAEBCHEN_SHELL_FUNCTIONS),y)
define FISCHSTAEBCHEN_DO_BUILD_SHELL_FUNCTIONS
	$(TARGET_MAKE_ENV) $(MAKE) -C '$(@D)/shellfunc' \
		$(FISCHSTAEBCHEN_SHELL_FUNCTIONS_MAKEOPTS) \
		METASH_DEFAULTS_FILE='$(@D)/metash_vdef.local' \
		functions
endef
FISCHSTAEBCHEN_POST_BUILD_HOOKS += FISCHSTAEBCHEN_DO_BUILD_SHELL_FUNCTIONS

define FISCHSTAEBCHEN_DO_INSTALL_SHELL_FUNCTIONS
	$(TARGET_MAKE_ENV) $(MAKE) -C '$(@D)/shellfunc' \
		$(FISCHSTAEBCHEN_SHELL_FUNCTIONS_MAKEOPTS) \
		METASH_DEFAULTS_FILE='$(@D)/metash_vdef.local' \
		DESTDIR='$(TARGET_DIR)' \
		install
endef
FISCHSTAEBCHEN_POST_INSTALL_TARGET_HOOKS += FISCHSTAEBCHEN_DO_INSTALL_SHELL_FUNCTIONS

endif # if BR2_PACKAGE_FISCHSTAEBCHEN_SHELL_FUNCTIONS
